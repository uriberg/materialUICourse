...
export default function LandingPage() {
    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
            ...
            <Grid item>
                <Grid container className={classes.servicesContainer} justify={matchesSM ? "center" : undefined}>
                    <Grid item style={{
                    ...
                    <Grid item>
                        <img className={classes.icon} alt="custom software development" src={customSoftwareIcon}/>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item>
                <Grid container className={classes.servicesContainer} justify={matchesSM ? "center" : "flex-end"}>
                    <Grid item style={{
                        marginLeft: matchesSM ? undefined : "5em",
                        textAlign: matchesSM ? "center" : undefined
                    }}>
                    ...
                    <Grid item>
                        <img className={classes.icon} alt="custom software development" src={mobileAppsIcon}/>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item>
